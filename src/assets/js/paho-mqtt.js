...
;(function ExportLibrary(root, factory) {
	...
	let PahoMQTT = (function(global) {
		// Private variables below, these are only visible inside the function closure
		// which is used to define the module.
		let version = '@VERSION@-@BUILDLEVEL@'
		 ...
		 * @ignore
		 */
		let Pinger = function(client, keepAliveInterval) {
			this._client = client
		 ...
		 * @ignore
		 */
		let Timeout = function(client, timeoutSeconds, action, args) {
